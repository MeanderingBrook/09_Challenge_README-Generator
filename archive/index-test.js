...
async function init() {
  ...
  // answers = await writeToFile();
  answers = await getUserInput();

  // NEED TO RETURN ANSWERS
  // badgeContent = generateMarkdown(answers);
...
//         writeToFile("./output/README.md", projectInfo);

//         fs.appendFile("./output/README.md", badgeContent, (err) => {
//           if (err) {
//             console.log(err);
//           } else {
//             console.log("Line 329: Badge was successfully written to file.");
//           }
//         });
...
//     fs.writeFile("./output/README.md", fileTitle, { flag: "a+" }, (err) => {
//       if (err) {
//         console.log(err);
//       } else {
//         console.log("Line 350: File Created Successfully");
//         // writeToFile();

//         try {
//           // const projectInfo = await inquirer.prompt(readmeFields);
//           const projectInfo = inquirer.prompt(readmeFields).then((answers) => {
//             console.log("Line 356: ", projectInfo);
